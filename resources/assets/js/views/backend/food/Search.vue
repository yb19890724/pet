    ...
    <div>
        <form class="form-horizontal">
            <div class="input-group col-lg-12 col-md-12 col-sm-12">
                <input type="text" name="name" v-model="form.search_name" class="form-control search-text" :placeholder="$t('placeholder.foodName')">
...
<script type="text/ecmascript-6">
    export  default{
        ...
        methods:{
            searchList(){
                this.$emit('searchListData',this.form);
            },
            reset(){
